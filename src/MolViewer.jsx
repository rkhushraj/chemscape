...
import { cross, normalize, atomBasis, circlePoints } from './geometry.js'
...
const THEME_COLORS = {
  dark: { bg: 0x080f1a, shell: '#0d3055', electron: '#7dd3fc' },
  light: { bg: 0xf0f8ff, shell: '#0369a1', electron: '#0284c7' },
}
